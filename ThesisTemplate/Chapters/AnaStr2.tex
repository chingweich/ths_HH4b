...
The filters remove most events having anomaly MET based on different information given from the detectors. All filters used are listed in table 3.6. %table 
\begin{table}[h!]
  \begin{center}
    \begin{tabular}{l}
    Triggers \\

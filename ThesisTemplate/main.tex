...
\thesistitle{
Search for Heavy Resonances Decaying into a Pair of Higgs Bosons in the Four b
quark Final State from pp Collisions at $\sqrt{s}$ =13 TeV with the CMS Detector} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle
...
\author{Ching-Wei Chen} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\begin{titlepage}
  \begin{center} \setstretch{1.15}
    ...
    \bigskip
    {\textcopyright \space \univname \space 2017. All rights reserved. \par}
...
%  \addchaptertocentry{\abstractname} % Add the abstract to the table of contents
  ...
  \bigskip
  \noindent{A search for heavy resonances decaying to a pair of Higgs bosons in the four b
quark final state is presented. The analysis is based on the data collected in 2016 with the CMS detector at LHC at center-of-mass energy $\sqrt{s}$ = 13 TeV, corresponding to integrated luminosity of 35.9 $fb^{-1}$. The Higgs bosons are reconstructed from high momentum $b\bar{b}$ quark pairs. The mass variable, $\tau_{21}$ discriminator, and double-b tagger are used for Higgs tagging. The signal regions are separated by double-b tagger into two categories. A 95\% upper limit on the production cross section of $\sigma_{X}\times \mathcal{B}(X \rightarrow HH \rightarrow b\bar{b}b\bar{b})$ is obtained from the combination of two categories with a limit below 10 fb for $m_X$ from 1200 to 3000 GeV. \par}
  \bigskip

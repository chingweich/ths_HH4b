...
void skimTree(int w , string st,string st2){
	...
	TFile* outFile= new TFile(Form("signal/%s.root",st2.data()),"recreate");
	for(int i=0;i<31;i++){
		for(int j=0;j<4;j++){
...
void skimTreeSignal(){
	...
	skimTree(1,"/data7/chchen/Jan142017/B/B1000.root","B1000");
	skimTree(1,"/data7/chchen/Jan142017/B/B1200.root","B1200");
	skimTree(1,"/data7/chchen/Jan142017/B/B1400.root","B1400");
	skimTree(1,"/data7/chchen/Jan142017/B/B1600.root","B1600");
	skimTree(1,"/data7/chchen/Jan142017/B/B1800.root","B1800");
	skimTree(1,"/data7/chchen/Jan142017/B/B2000.root","B2000");
	skimTree(1,"/data7/chchen/Jan142017/B/B2500.root","B2500");
	skimTree(1,"/data7/chchen/Jan142017/B/B3000.root","B3000");
	skimTree(1,"/data7/chchen/Jan142017/B/B4000.root","B4000");
	skimTree(1,"/data7/chchen/Jan142017/B/B4500.root","B4500");

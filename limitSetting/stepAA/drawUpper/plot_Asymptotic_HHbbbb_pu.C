...
void plot_Asymptotic_HHbbbb(string input, string outputdir, int sigHyp, int subtr)
{
  ...
  TFile *fout = new TFile(Form("%s/limit.root",outputdir.data()),"RECREATE");  
...
//  gROOT->LoadMacro("CMS_lumi.C");
  ...
  int Xmass_thr[nXm_thr]={1000,1200,1400,1600,1800,2000,2500,3000};  
  int Xmass[nXm]={1200,1400,1600,1800,2000,2500};  
  ...
  for(int n=0;n<nXm;n++)
  {
    ...
    fFREQ[n] = new TFile(Form("%s/CMS_%d_HH4b_13TeV_asymptoticCLs.root",input.data(),Xmass[n]), "READ");
...
//    leg->AddEntry(grthSM10, "#sigma_{TH} x BR(Z' #rightarrow " + VV + "), #tilde{k}=0.20", "L"); // #rightarrow 2l2q
  ...
  cMCMC->SaveAs(sOutput.c_str());
	...
	cMCMC->Print(Form("%s/limit.pdf",outputdir.data()));
...
void plot_Asymptotic_HHbbbb_pu(){
	plot_Asymptotic_HHbbbb("central_noUncert","central_noUncert",20,1);
	plot_Asymptotic_HHbbbb("central_noUncert/TT","central_noUncert/TT",20,1);
	plot_Asymptotic_HHbbbb("central_noUncert/LL","central_noUncert/LL",20,1);
	
	plot_Asymptotic_HHbbbb("puDn_noUncert","puDn_noUncert",20,1);
	plot_Asymptotic_HHbbbb("puDn_noUncert/TT","puDn_noUncert/TT",20,1);
	plot_Asymptotic_HHbbbb("puDn_noUncert/LL","puDn_noUncert/LL",20,1);
	
	
	plot_Asymptotic_HHbbbb("puUp_noUncert","puUp_noUncert",20,1);
	plot_Asymptotic_HHbbbb("puUp_noUncert/TT","puUp_noUncert/TT",20,1);
	plot_Asymptotic_HHbbbb("puUp_noUncert/LL","puUp_noUncert/LL",20,1);
}

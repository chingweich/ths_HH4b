...
#                  quickplot(sigpath+"BulkGrav_M-%s_0.root"%(m), "mynewTree", Signal_mX_pu_down, variable2, TightT2, "puWeightsDown*SFTight/1.")
		...
		# Signal_mX_antitag_pu_up.Write()
		# Signal_mX_antitag_pu_down.Write()
		# Signal_mX_antitag_FJEC_Up.Write()
		# Signal_mX_antitag_FJEC_Down.Write()
		# Signal_mX_antitag_FJER_Down.Write()
		# Signal_mX_antitag_FJER_Up.Write()

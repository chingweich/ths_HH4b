...
void Background_fast_LL(int rebin_factor=rebin,int model_number = 0,int imass=750, bool plotBands = false)
{
/*    if(LLregion){
      SR_hi = 2843.;
    }else{
...
//    Line2->SetLineWidth(2);
	...
	if (LLregion){
      std::cout<< "pre bg_p1_LL_   param   "<<bg_p1_LL.getVal() <<  " "<<bg_p1_LL.getError()<<std::endl;
      std::cout<< "pre bg_p2_LL_   param   "<<bg_p2_LL.getVal() <<  " "<<bg_p2_LL.getError()<<std::endl;
      std::cout<< "pre mjjlin_LL_  param   "<<mjjlin_LL.getVal() <<  " "<<mjjlin_LL.getError()<<std::endl;
    }else{
      std::cout<< "pre bg_p1_TT_   param   "<<bg_p1_TT.getVal() <<  " "<<bg_p1_TT.getError()<<std::endl;
      std::cout<< "pre bg_p2_TT_   param   "<<bg_p2_TT.getVal() <<  " "<<bg_p2_TT.getError()<<std::endl;
      std::cout<< "pre mjjlin_TT_  param   "<<mjjlin_TT.getVal() <<  " "<<mjjlin_TT.getError()<<std::endl;
    }

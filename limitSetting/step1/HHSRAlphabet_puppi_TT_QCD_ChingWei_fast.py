...
TightT2         = "jet2bbtag > 0.8 & jet2_puppi_msoftdrop_TheaCorr > 105 & jet2_puppi_msoftdrop_TheaCorr < 135  &jet2pt>300&jet1pt>300&abs(jet1eta-jet2eta)<1.3&jet1_puppi_tau21<0.55&jet2_puppi_tau21<0.55&dijetmass_softdrop_corr>750&abs(jet1eta)<2.4&abs(jet2eta)<2.4&jet1_puppi_msoftdrop_TheaCorr>105&jet1_puppi_msoftdrop_TheaCorr<135&(jet1bbtag>0.8)&(HLT_PFHT900||HLT_PFHT800||HLT_AK8PFHT650_TrimR0p1PT0p03Mass50||HLT_AK8PFHT700_TrimR0p1PT0p03Mass50||HLT_AK8PFJet360_TrimMass30||HLT_PFHT650_WideJetMJJ900DEtaJJ1p5||HLT_AK8DiPFJet280_200_TrimMass30_BTagCSV_p20)"
...
norm500 = GetNom("/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD500.root")
norm700 = GetNom("/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD700.root")
norm1000 = GetNom("/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD1000.root")
norm1500 = GetNom("/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD1500.root")
norm2000 = GetNom("/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD2000.root")

############# DATASETS: #################
QCD1 = DIST("DATA1", "/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD500.root","mynewTree",str(Options.lumi)+"*31630./"+str(norm500))
QCD2 = DIST("DATA2", "/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD700.root","mynewTree",str(Options.lumi)+"*6802./"+str(norm700))
QCD3 = DIST("DATA3", "/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD1000.root","mynewTree",str(Options.lumi)+"*1206./"+str(norm1000))
QCD4 = DIST("DATA4", "/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD1500.root","mynewTree",str(Options.lumi)+"*120.4/"+str(norm1500))
QCD5 = DIST("DATA5", "/afs/cern.ch/work/c/chchen/public/Summer2016QCD/QCD2000.root","mynewTree",str(Options.lumi)+"*25.25/"+str(norm2000))
...
FILE = TFile("outputs/th_TT.root", "RECREATE")

# C1 = TCanvas("C1", "", 800, 600)
# C1.cd()
Hbb.TwoDPlot.SetName("ths_2D")
Hbb.TwoDPlot.Write()
...
Hbb.truthG.SetName("ths_1D_truth")
Hbb.truthG.Write()

Hbb.Fit.fit.SetName("ths_fit")
Hbb.Fit.fit.Write()
Hbb.Fit.ErrUp.SetName("ths_ErrUp")
Hbb.Fit.ErrUp.Write()

Hbb.Fit.ErrDn.SetName("ths_ErrDn")
Hbb.Fit.ErrDn.Write()
...
SIG0.SetName("ths_SIG0")
SIG0.Write()

SIG0.SetName("ths_SIG1")
SIG1.Write()

SIG0.SetName("ths_SIG2")
SIG2.Write()

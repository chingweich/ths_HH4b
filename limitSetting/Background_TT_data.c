...
void Background_TT_data(int rebin_factor=rebin,int model_number = 0,int imass=750, bool plotBands = false)
{
    rebin = rebin_factor;
    std::string fname;
    if (LLregion) {
...
//        h_SR_Prediction=(TH1F*)h_mX_EST->Clone("h_SR_Prediction");
    ...
    RooRealVar bg_p11a((std::string("bg_p11a_")).c_str(), "bg_p1",1,-10, 10.);
    RooRealVar bg_p2((std::string("bg_p2_")).c_str(), "bg_p2",  -10, 10.);
    RooRealVar bg_p3((std::string("bg_p3_")).c_str(), "bg_p3",  -10, 10.);
...
//    RooGenericPdf bg = RooGenericPdf((std::string("bg_")).c_str(),"exp(-@0*@2/(1+(@0*@1*@2)))",RooArgList(x,bg_p1,bg_p2));
    ...
    RooGenericPdf bgSB1a = RooGenericPdf((std::string("bgSB1a_")).c_str(),"exp(-@0*@1)",RooArgList(x,bg_p11a));
 //   RooGenericPdf bgSB1b = RooGenericPdf((std::string("bgSB1b_")).c_str(),"exp(-@0*@2/(1+(@0*@1*@2)))",RooArgList(x,bg_p1,bg_p2));
    RooGenericPdf bgSB1c = RooGenericPdf((std::string("bgSB1c_")).c_str(),"exp(-@0*@2/(1+(@0*@1*@2))-@0*@0*@3/(1+@0*@0*@2*@3))",RooArgList(x,bg_p1,bg_p2,bg_p3));
...
//    pave->Draw("SAME"); 
    ...
    bgSB1a.fitTo(predSB, RooFit::Range(SR_lo, SR_hi), RooFit::Save());
    bgSB1c.fitTo(predSB, RooFit::Range(SR_lo, SR_hi), RooFit::Save());
